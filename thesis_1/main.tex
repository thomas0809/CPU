...
\begin{titlepage}
\begin{center}
\includegraphics[width=0.3\textwidth]{thu.png}\\[1cm]
\textsc{\LARGE \univname}\\[0.8cm] % University name
\textsc{\LARGE 计算机组成原理}\\[0.8 cm] % Thesis type
...
%\textit{in the}\\[0.4cm]
\univname\\[0.5cm]\deptname\\[2cm] % Research group name and department name
